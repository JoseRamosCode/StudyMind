...
public class Plantilla2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel17.setBackground(new java.awt.Color(221, 230, 237));
        jPanel17.setLayout(null);

        jButton13.setBackground(new java.awt.Color(221, 230, 237));
        jButton13.setBorder(null);
        jButton13.setFocusPainted(false);
        jPanel17.add(jButton13);
        jButton13.setBounds(20, 239, 52, 60);

        jButton14.setBackground(new java.awt.Color(221, 230, 237));
        jButton14.setBorder(null);
        jButton14.setFocusPainted(false);
        jPanel17.add(jButton14);
        jButton14.setBounds(20, 320, 52, 60);

        jButton15.setBackground(new java.awt.Color(221, 230, 237));
        jButton15.setBorder(null);
        jButton15.setFocusPainted(false);
        jPanel17.add(jButton15);
        jButton15.setBounds(20, 420, 52, 49);

        jButton16.setBackground(new java.awt.Color(221, 230, 237));
        ...
        jButton16.setBounds(20, 20, 52, 49);

        jButton17.setBackground(new java.awt.Color(221, 230, 237));
        jButton17.setBorder(null);
        jButton17.setFocusPainted(false);
        jPanel17.add(jButton17);
        jButton17.setBounds(20, 520, 52, 49);

        jButton18.setBackground(new java.awt.Color(240, 245, 250));
        jButton18.setBorder(null);
        jButton18.setFocusPainted(false);
        jPanel17.add(jButton18);
        jButton18.setBounds(20, 150, 52, 49);

        jPanel18.setBackground(new java.awt.Color(240, 245, 250));
        ...
        jPanel18.setBounds(0, 140, 260, 70);
        ...
        jLabel3.setBounds(80, 340, 140, 30);
        ...
        jLabel4.setBounds(80, 440, 150, 29);
        ...
        jLabel5.setBounds(90, 530, 160, 29);
    ...
    private void jButton16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton16ActionPerformed
        Horario Horario = new Horario(); // crea la ventana
